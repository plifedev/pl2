...
[ 1 , "Votre véhicule est prêt et assuré !" ] RemoteExecCall [ "life_fnc_broadcast" , _unit];
}else{
[ 1 , "Votre véhicule est prêt et non assuré " ] RemoteExecCall [ "life_fnc_broadcast" , _unit];
};
serv_sv_use deleteAt _servIndex;