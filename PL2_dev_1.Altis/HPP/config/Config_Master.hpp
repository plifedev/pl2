...
/* System Settings */
    ...
    respawn_timer = 3; //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    vehicle_purchase_multiplier_DEP = .01; //dep Vehicle Buy Price = Config_Vehicle price * multiplier

    /* Vehicle Rental Prices */
    vehicle_rental_multiplier_CIVILIAN = .30; //Civilian Vehicle Rental Price = Config_Vehicle price * multiplier
    ...
    vehicle_rental_multiplier_DEP = .3; //Medic Vehicle Rental Price = Config_Vehicle price * multiplier
    ...
    vehicle_sell_multiplier_DEP = .05; //Medic Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
    
    /* Vehicle Insurance Prices */  
    vehicle_insurance_multiplier_CIVILIAN = .10; //Civilian Vehicle Insurance Price = Vehicle Buy Price * multiplier  
    vehicle_insurance_multiplier_COP = .05; //Cop Vehicle Insurance Price = Vehicle Buy Price * multiplier  
    vehicle_insurance_multiplier_MEDIC = .05; //Medic Vehicle Insurance Price = Vehicle Buy Price * multiplier  
    vehicle_insurance_multiplier_OPFOR = -1; // -- NOT IN USE -- Simply left in for east support. 
    vehicle_insurance_multiplier_DEP = .05; //Medic Vehicle Insurance Price = Vehicle Buy Price * multiplier 
