...
[] call compile preprocessFileLineNumbers "SQF\clientValidator.sqf";
enableSentences false;

//Setup initial client core functions
diag_log "::Life Client:: Initialization Variables";
[] call compile preprocessFileLineNumbers "SQF\configuration.sqf";
...
if (LIFE_SETTINGS(getNumber,"pump_service") isEqualTo 1) then {
    [] execVM "SQF\fn_setupStationService.sqf";
};
