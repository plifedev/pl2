...
if(_action) then {
	if(miol45a560g < _upgradePrice) exitWith {
		hint parseText format[
			...
			[miol45a560g] call life_fnc_numberText,
			[_upgradePrice - miol45a560g] call life_fnc_numberText
		];
	};
	SUB(miol45a560g,_upgradePrice);
