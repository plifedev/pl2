...
lbClear _units;
CONTROL(2700,2701) ctrlSetStructuredText parseText format["<img size='1.7' image='icons\bank.paa'/> %1€<br/><img size='1.6' image='icons\money.paa'/> %2€",[miol45a560g] call life_fnc_numberText,[uj748rtaz1] call life_fnc_numberText];
