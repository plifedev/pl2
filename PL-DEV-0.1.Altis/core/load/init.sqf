...
switch (playerSide) do {
	case west: {
		miol45a560g = LIFE_SETTINGS(getNumber,"bank_cop");
		life_paycheck = LIFE_SETTINGS(getNumber,"paycheck_cop");
	};
	case civilian: {
		miol45a560g = LIFE_SETTINGS(getNumber,"bank_civ");
		life_paycheck = LIFE_SETTINGS(getNumber,"paycheck_civ");
	};
	case independent: {
		miol45a560g = LIFE_SETTINGS(getNumber,"bank_med");
		life_paycheck = LIFE_SETTINGS(getNumber,"paycheck_med");
	};
	case east: {
		miol45a560g = LIFE_SETTINGS(getNumber,"bank_armer");
...
if(EQUAL(LIFE_SETTINGS(getNumber,"Pump_service"),1)) then{
	[] execVM "core\scripts\station_service.sqf";
};
