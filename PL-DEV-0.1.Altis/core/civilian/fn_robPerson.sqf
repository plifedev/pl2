...
if(uj748rtaz1 > 0) then {
	[uj748rtaz1,player,_robber] remoteExecCall ["life_fnc_robReceive",_robber];
	//[getPlayerUID _robber,_robber GVAR ["realname",name _robber],"211"] remoteExecCall ["life_fnc_wantedAdd",RSERV];
	[1,"STR_NOTF_Robbed",true,[_robber GVAR ["realname",name _robber],profileName,[uj748rtaz1] call life_fnc_numberText]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
	uj748rtaz1 = 0;
	...
	_amount = [uj748rtaz1] call life_fnc_numberText;
	_type = 5;
